 ...
 *
 * Three components used to carry their own copy of this try/catch/finally, which is three
 * chances to forget to clear the error or to leave the button disabled after a failure.
 *
